...
# @app.route('/Traffic_signal_controlling', methods=['GET', 'POST'])
# def Traffic_signal_controlling():
#     if request.method == 'POST':
...
#             process_videos(app.config['UPLOAD_FOLDER'], model)

#             return redirect(url_for('Traffic_signal_controlling'))  # Redirect after processing

#     return render_template('traffic_video.html')  # Render upload page
...
@app.route('/Traffic_signal_controlling', methods=['GET'])
def Traffic_signal_controlling():
    #cctv_ips = app.config['CAMERA_IPS']
    return render_template('Traffic_signal_controlling.html')
...
def accident_detection():
    ...
    try:
        ...
        model_path = r"C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\PROJECT_INTERNSHIP_TRAFFIC _2 (3)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT\models\best.pt"  # Use your YOLO model path
