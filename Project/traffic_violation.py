...
# DB_HOST = 'localhost'
# DB_USER = 'root'
# DB_PASSWORD = 'Mugdhi@15'
# DB_NAME = 'traffic management db'

def dbconnection():
     connection = pymysql.connect(host='127.0.0.1',database='traffic management db',user='root',password='Mugdhi@15')
     return connection
 
# def create_database_and_table(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME):
#     try:
...
#         connection = None  # Ensure connection is set to None on error
#     finally:
...
license_plate_cascade = cv2.CascadeClassifier(r"C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\PROJECT_INTERNSHIP_TRAFFIC _2 (3)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT\models\YOLO\haarcascade_russian_plate_number.xml")
...
def main():
    ...
    # Open the video file
    vid = cv2.VideoCapture(r"C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\PROJECT_INTERNSHIP_TRAFFIC _2 (3)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT\static\uploads\signal_jumping.mp4")
...
if __name__ == "__main__":
    main()
    # video_path = r"C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\PROJECT_INTERNSHIP_TRAFFIC _2 (3)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT\static\uploads\signal_jumping.mp4"
