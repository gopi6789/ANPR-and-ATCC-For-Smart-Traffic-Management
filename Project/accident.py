...
class AccidentDetectionSystem:
    ...
    def detect_accident(video_paths):
        ...
        MODEL_PATH = r"C:\Users\Mugdhi Saxena\Documents\Mugdhi S\Infosys Springboard\internship\PROJECT_INTERNSHIP_TRAFFIC _2 (3)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT_INTERNSHIP_TRAFFIC _2 (2)\PROJECT\models\best.pt"  # Replace with the path to your model
